/**
 * 소셜 로그인 버튼용 아이콘 (서비스별 공식 컬러·형태 반영)
 */
...
export function KakaoIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" width="20" height="20" aria-hidden>
      <path
        fill="#191919"
        d="M12 3c5.8 0 10.5 3.66 10.5 8.18 0 4.52-4.7 8.18-10.5 8.18-1.07 0-2.1-.14-3.08-.4l-3.48 1.16-.95-2.9c-1.76-1.14-2.97-2.78-2.97-4.64C1.5 6.66 6.2 3 12 3z"
      />
    </svg>
  );
}
