...
<div class="admin-page">
    ...
    <div class="card admin-grid-wrap" style="flex:1 1 0%; min-height:0; display:flex; flex-direction:column; padding:0.35rem;">
        <div id="cart-grid" data-ax5grid="cart-grid" style="height:100%; min-height:240px;"></div>
    </div>
</div>

<script>
(function() {
var apiBase = '/admin/cart_items/api.php';
...
function initGrid() {
    ...
    gridInstance.setConfig({
        ...
        columns: [
            ...
            { key: 'created_at', label: '담은일시', width: 160, align: 'left' }
        ]
    });
